    ...
    const handleSubmit = useCallback(
        async (data: ProfileFormData) => {
            try {
                ...
                addToast({
                    type: 'success',
                    title: 'Perfil atualizado man, ser for foto zoada já tira ',
                    description: 'Alteração de dados realizadas com sucesso!',
                });
            } catch (err) {
                ...
                >
                    <AvatarInput>
                        ...
                        <label htmlFor='avatar' >
                            <FiCamera />
                            <input type="file" id='avatar' onChange={handelAvatarChange} />
                        </label>
                    </AvatarInput>
